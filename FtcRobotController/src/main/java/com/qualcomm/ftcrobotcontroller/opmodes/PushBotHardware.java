...

{
...

    {
        ...
        try
        {
            v_motor_left_drive = hardwareMap.dcMotor.get ("motorLeft");
        }
        ...
        try
        {
            v_motor_right_drive = hardwareMap.dcMotor.get ("motorRight");
    ...
    private Servo flipClimbers;
    private Servo swipeLeft;
    private Servo swipeRight;
    ...
    public boolean isWhite() {
        if(odSensor.getLightDetected() > 0.10)
            return true;
        return false;
    }

    public double getWhiteness() {
        return odSensor.getLightDetected();
    }
